...
## Firstly: QMK & [VIA](https://www.caniusevia.com/)
For simple QMK Macropad or just VIA compatibility, first [install qmk CLI](https://docs.qmk.fm/#/getting_started_build_tools).<br>
