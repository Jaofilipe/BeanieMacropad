...
Windows specific
- If drivers are required for your Pro Micro, install appropriate USB drivers or use Zadig for special cases.
- In most cases the ATmega32U4 enumerates as a COM device automatically.  
